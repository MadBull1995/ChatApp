...
namespace ChatApp;
public class AuthGuardInterceptor : Interceptor
{
    private readonly ILogger<AuthGuardInterceptor> _logger;

    public AuthGuardInterceptor(ILogger<AuthGuardInterceptor> logger)
    {
        _logger = logger;
    }
